...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract frames from datasets")
    parser.add_argument('--id', type=str, nargs='+', help="Dataset ID(s) to process. eg., 032 or multiple IDs separated by space")
    ...
    SIZE = [2048, 2048]
    SIZE_LOWRES = [256, 256]
    DATA_SOURCE = '/purestorage/enroot/yc4ny/datasets/nersemble_raw'
    DATA_OUTPUT = 'preprocessed_nersemble'

    extract_frames(args.id)