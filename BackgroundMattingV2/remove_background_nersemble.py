...
if __name__ == "__main__":
    ...
    parser.add_argument('--id',type=str, help='ID of the data to perform background matting' )
    args = parser.parse_args()

    DATA_SOURCE = '../preprocessed_nersemble_part'
    ...
    data_folder = os.path.join(DATA_SOURCE, args.id)
    print("------------------------------------------------")
    print(f"Preprocessing: {id} sequence")
    print("------------------------------------------------")
